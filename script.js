...
function createCard(element, howDiscovered, suit, name) {
    ...
    switch (name) {
        case "In a field taller than you.":
            cardImg.src = "field.jpg";
            break;
        case "Under the light of the moon":
            cardImg.src = "moonlight.jpg";
            break;
        case "By a gentle river":
            cardImg.src = "river.jpg";
            break;
        case "In a steep canyon":
            cardImg.src = "canyon.jpg";
            break;
        case "In a treetop":
            cardImg.src = "treetop.jpg";
            break;
        case "On the snowy peak of a mountain":
            cardImg.src = "snowy.jpg";
            break;
        case "Near a volcano":
            cardImg.src = "volcano.jpg";
            break;
        case "On a glacier":
            cardImg.src = "glacier'jpg";
            break;
        case "Deep Underground":
            cardImg.src = "underground.jpg";
            break;
        case "On a cliff face":
            cardImg.src = "cliff.jpg";
            break;
        case "In the desert":
            cardImg.src = "desert.jpg";
            break;
        case "In deep water":
            cardImg.src = "underwater.jpg";
            break;
        case "Floating in the air":
            cardImg.src = "sky.webp";
